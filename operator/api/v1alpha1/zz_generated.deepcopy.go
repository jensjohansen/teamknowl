...
func (in *KnowledgeBaseSpec) DeepCopyInto(out *KnowledgeBaseSpec) {
	*out = *in
	...
	out.UserInterface = in.UserInterface
	out.API = in.API
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *UserInterfaceConfig) DeepCopyInto(out *UserInterfaceConfig) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new UserInterfaceConfig.
func (in *UserInterfaceConfig) DeepCopy() *UserInterfaceConfig {
	if in == nil {
		return nil
	}
	out := new(UserInterfaceConfig)
	in.DeepCopyInto(out)
	return out
}
